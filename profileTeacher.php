...
<head>
    ...
    <style>
        ...
        input[type=submit]:hover {background-color: #787A91; color: black;}
        ...
        <div class="pannel">
            ...
            <div class="table-respnsive">
                ...
                <tbody>
                        ...
                        <tr>    
                            <th>Edit Profile:</th>
                            <td> <a href="ProfileUpdateTeacher.php?Tid=<?php echo $_SESSION['Tid']; ?>"> <i class="fa fa-edit" aria-hidden="true"></i></a>
                        </tr>
                        </tbody>
