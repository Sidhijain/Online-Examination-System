    ...
    <script type="text/javascript">
        ...
        <div class="center-div">
                    <div class="table-responsive">
                        <table>
                            <caption style="text-align:center; font-size: large;"> <b> <u> ACADEMIC TABLE</u> </b> </caption>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php
                                   ...
                                   if(isset($_POST['update'])){
                                       $updatequery= "UPDATE academic SET Academicabb='$_POST[Academicabb]' WHERE  Academicname='$_POST[Academicname]' " ;
                                       mysqli_query($conn,$updatequery);
                                       };

                                   if(isset($_POST['delete'])){
                                           $idupdate=$_POST['Academicname'];
                                           $deletequery= "DELETE FROM academic WHERE Academicname='$idupdate' " ;
                                   ...
                                   ?>
                                       <form action="" method="POST">
                                           <tr> 
                                                   ...
                                                   <td><input type= 'text' name='Academicname' value="<?php echo $res['Academicname']; ?>"> </td>
                                                   <td><input type= 'text' name='Academicabb' value="<?php echo $res['Academicabb']; ?>"> </td>
                               ...
                               if(isset($_POST['add'])){
                                $addquery= "INSERT INTO academic (Academicname, Academicabb) VALUES ('$_POST[Academicname]', '$_POST[Academicabb]') " ;
                                $data=mysqli_query($conn,$addquery);
                                    ...
                                    if($data)
                                    {
                                        ?>
                                        <script type="text/javascript">
                                            window.location = "AcademicUp.php";
                                        </script>   
                                        <?php 
                                    }
                            ...
                            ?>
                                <form action="" method="POST">  
                                    <tr>
                                        <td><input type= 'text' name='Academicname' > </td>
                                        <td><input type= 'text' name='Academicabb' > </td>    
