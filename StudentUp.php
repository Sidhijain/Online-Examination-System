    ...
    <script type="text/javascript">
        ...
        <div class="center-div">
                    <div class="table-responsive">
                        <table>
                        <caption style="text-align:center; font-size: large;"> <b> <u> STUDENT TABLE</u> </b> </caption>
                            <thead>
                                <tr>
                                   <th>ID</th>
                                    <th>Enroll No.</th>
                            ...
                            <tbody>
                                <?php
                                   ...
                                   if(isset($_POST['update'])){
                                       $updatequery= "UPDATE student SET Name='$_POST[Name]' ,Eno='$_POST[Eno]' ,Rollno='$_POST[Rollno]' ,Email='$_POST[Email]' ,Contactno='$_POST[Contactno]' ,Altcontactno='$_POST[Altcontactno]'  WHERE  Sid='$_POST[Sid]' " ;
                                       mysqli_query($conn,$updatequery);
                                       };

                                   if(isset($_POST['delete'])){
                                    $idupdate=$_POST['Sid'];
                                           $deletequery= "DELETE FROM student WHERE  Sid='$idupdate' " ;
                                   ...
                                   ?>
                                       <form action="" method="POST">
                                           <tr> 
                                                   <td><input type= 'text' name='Sid' value="<?php echo $res['Sid']; ?>" size="10"> </td>
                                                   <td><input type= 'text' name='Eno' value="<?php echo $res['Eno']; ?>"  size="10"> </td>
                                                   <td><input type= 'text' name='Rollno' value="<?php echo $res['Rollno']; ?>" size="10"> </td>
                                                   <td><input type= 'text' name='Name' value="<?php echo $res['Name']; ?>" size="10"> </td>
                                                   <td><input type= 'text' name='Email' value="<?php echo $res['Email']; ?>"> </td>
                                                   <td><input type= 'text' name='Contactno' value="<?php echo $res['Contactno']; ?>" size="10"> </td>
                                                   <td><input type= 'text' name='Altcontactno' value="<?php echo $res['Altcontactno']; ?>" size="10"> </td>
