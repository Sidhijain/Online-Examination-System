...
<div>
    ...
    <div> 
    <div class="dropdown">
        <label for="updatedb">Choose a Table:</label>
    ...
    <script type="text/javascript">
        ...
        <div class="center-div">
                    <div class="table-responsive">
                        <table>
                        <caption style="text-align:center; font-size: large;"> <b> <u> TEACHER TABLE</u> </b> </caption>
                            <thead>
                                <tr>
                                   <th>SmartCard ID</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                <?php
                                   ...
                                   if(isset($_POST['update'])){
                                       $updatequery= "UPDATE teacher SET Tname='$_POST[Tname]' ,Dept='$_POST[Dept]' ,Phno='$_POST[Phno]' ,Email='$_POST[Email]' WHERE  Tid='$_POST[Tid]' " ;
                                       mysqli_query($conn,$updatequery);
                                       };

                                   if(isset($_POST['delete'])){
                                    $idupdate=$_POST['Tid'];
                                           $deletequery= "DELETE FROM teacher WHERE  Tid='$idupdate' " ;
                                   ...
                                   ?>
                                       <form action="" method="POST">
                                           <tr> 
                                                  <td><input type= 'text' name='Tid' value="<?php echo $res['Tid']; ?>"> </td>
                                                  <td><input type= 'text' name='Tname' value="<?php echo $res['Tname']; ?>"> </td>
                                                  <td><input type= 'text' name='Dept' value="<?php echo $res['Dept']; ?>"> </td>
                                                  <td><input type= 'text' name='Phno' value="<?php echo $res['Phno']; ?>"  size="10"> </td> 
