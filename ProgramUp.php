        ...
        urlMenu.onchange = function () {
         ...
         <div class="center-div">
                    <div class="table-responsive">
                        <table>
                        <caption style="text-align:center; font-size: large;"> <b> <u> PROGRAM TABLE</u> </b> </caption>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php
                                   ...
                                   if(isset($_POST['update'])){
                                       $updatequery= "UPDATE programme SET Programabb='$_POST[Programabb]' WHERE  Programname='$_POST[Programname]' " ;
                                       mysqli_query($conn,$updatequery);
                                       };

                                   if(isset($_POST['delete'])){
                                    $idupdate=$_POST['Programname'];
                                           $deletequery= "DELETE FROM programme WHERE  Programname='$idupdate' " ;
                                   ...
                                   ?>
                                       <form action="" method="POST">
                                           <tr> 
                                                   ...
                                                   <td><input type= 'text' name='Programname' value="<?php echo $res['Programname']; ?>"> </td>
                                                   <td><input type= 'text' name='Programabb' value="<?php echo $res['Programabb']; ?>"> </td>
                                   ...
                                   <?php    
                                    ...
                                    if(isset($_POST['add'])){
                                        $addquery= "INSERT INTO programme (Programname, Programabb) VALUES ('$_POST[Programname]', '$_POST[Programabb]') " ;
                                    ...
                                    ?>
                                        <form action="" method="POST">  
                                            <tr>
                                                ...
                                                <td><input type= 'text' name='Programabb' > </td>    
