    ...
    <script type="text/javascript">
        ...
        <div class="center-div">
                    <div class="table-responsive">
                        <table>
                        <caption style="text-align:center; font-size: large;"> <b> <u> ADMIN TABLE</u> </b> </caption>
                            <thead>
                                <tr>
                                   <th>SmartCard ID</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                <?php
                                   ...
                                   if(isset($_POST['update'])){
                                       $updatequery= "UPDATE admin SET  Email='$_POST[Email]' ,Name='$_POST[Name]' WHERE  Aid='$_POST[Aid]' " ;
                                       mysqli_query($conn,$updatequery);
                                       };

                                   if(isset($_POST['delete'])){
                                    $idupdate=$_POST['Aid'];
                                           $deletequery= "DELETE FROM admin WHERE  Aid='$idupdate' " ;
                                   ...
                                   ?>
                                       <form action="" method="POST">
                                           <tr> 
                                                  <td><input type= 'text' name='Aid' value="<?php echo $res['Aid']; ?>"> </td>
