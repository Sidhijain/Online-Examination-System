        ...
        <div class="main">
            <form action="#" method="POST">
                ...
                <div class="input_field">
                    ...
                    <input type="text" class="input" placeholder="Enter 10 Digit Id" name ="Tid" required>
                </div>
                <br>
                <div class="input_field">
                    <label>Name :</label>
                    <input type="text" class="input" placeholder="Enter Your Name" name ="Tname" required>
                </div>
                <br>
                <div class="input_field">
                    <label>Department :</label>
                    <input type="text" class="input" placeholder="Enter Department" name ="Dept" required>
                </div>
                <br>
                <div class="input_field">
                    <label>Phone No. :</label>
                    <input type="text" class="input" placeholder="Enter 10 Digit Number" name ="Phno" required>
                </div>
                <br>
                <div class="input_field">
                    <label>E-mail : </label>
    ...
    if($res==0)
        {
            if($ps == $rps)
                {
                    $query="INSERT INTO teacher values('$id', '$nm', '$dp', '$phn', '$em', '$ps', '$rps')";
                    $data=mysqli_query($conn, $query);  // if conn done then my query should be inserted
                ...
                { 
                    ?>
                    <script>
                        swal("Password incorrect!", "Please Enter Correct Password!", "error");
                    </script>
                    <?php
                } 
        }     
        ...
        ?>
        <script>
            swal("USer ID Already Exists!", "Please Log In!", "error");
        </script>
        <?php
    }   
