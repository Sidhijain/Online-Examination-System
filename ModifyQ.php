                                   ...
                                   ?>
                                       <form action="" method="POST">
                                           <tr> 
                                                   ...
                                                   <td> <a href="UpdateQuestion.php?Qid=<?php echo $res['Qid']; ?>"> <i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                   <td> <a href="DeleteQuestion.php?Qid=<?php echo $res['Qid']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                           </tr>
                                       </form>
                                   <?php    
                               }
