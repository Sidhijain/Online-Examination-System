    ...
    <style>
      body {
        ...
        /* .center-div {
            ...
            background: -webkit-linear-gradient(left, #FDADE2, #00c6ff);
            padding: 20px 0 0 0;
        ...
        <div class="center-div">
            <div class="table-respnsive">
                ...
                <tbody>
                        ...
                        <tr>
                            <th>Edit Profile:</th>
                            <td> <a href="ProfileUpdateAdmin.php?Aid=<?php echo $_SESSION['Aid']; ?>"> <i class="fa fa-edit" aria-hidden="true"></i></a>
                        </tr>
                        </tbody>
