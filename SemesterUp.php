    ...
    <script type="text/javascript">
        ...
        <div class="center-div">
                    <div class="table-responsive">
                        <table>
                        <caption style="text-align:center; font-size: large;"> <b> <u> SEMESTER TABLE</u> </b> </caption>
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Abbreviation</th> 
                            ...
                            <tbody>
                                <?php
                                   ...
                                   if(isset($_POST['update'])){
                                       $updatequery= "UPDATE semester SET  Semabb='$_POST[Semabb]' WHERE  Semname='$_POST[Semname]' " ;
                                       mysqli_query($conn,$updatequery);
                                       };

                                   if(isset($_POST['delete'])){
                                    $idupdate=$_POST['Semname'];
                                           $deletequery= "DELETE FROM semester WHERE Semname='$idupdate' " ;
                                   ...
                                   ?>
                                       <form action="" method="POST">
                                           <tr> 
                                                   <td><input type= 'text' name='Semname' value="<?php echo $res['Semname']; ?>"> </td>
                                                   <td><input type= 'text' name='Semabb' value="<?php echo $res['Semabb']; ?>"> </td>
                               ...
                               if(isset($_POST['add'])){
                                $addquery= "INSERT INTO semester (Semname, Semabb) VALUES ('$_POST[Semname]', '$_POST[Semabb]') " ;
                                $data=mysqli_query($conn,$addquery);
                                    ...
                                    if($data)
                                    {
                                        ?>
                                        <script type="text/javascript">
                                            window.location = "SemesterUp.php";
                                        </script>   
                                        <?php 
                                    }
                            ...
                            ?>
                                <form action="" method="POST">  
                                    <tr>
                                        <td><input type= 'text' name='Semname' > </td>
                                        <td><input type= 'text' name='Semabb' > </td>    
