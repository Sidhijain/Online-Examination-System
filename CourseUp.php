                            ...
                            <tbody>
                                <?php
                                   ...
                                   if(isset($_POST['update'])){
                                       $updatequery= "UPDATE course SET Cname='$_POST[Cname]' ,Cabb='$_POST[Cabb]' WHERE  Ccode='$_POST[Ccode]' " ;
                                       mysqli_query($conn,$updatequery);
                                       };

                                   if(isset($_POST['delete'])){
                                    $idupdate=$_POST['Ccode'];
                                           $deletequery= "DELETE FROM course WHERE Ccode='$idupdate' " ;
                                   ...
                                   ?>
                                       <form action="" method="POST">
                                           <tr> 
                                                  <td><input type= 'text' name='Ccode' value="<?php echo $res['Ccode']; ?>"> </td>
                                                   <td><input type= 'text' name='Cname' value="<?php echo $res['Cname']; ?>"> </td>
                                                   <td><input type= 'text' name='Cabb' value="<?php echo $res['Cabb']; ?>"> </td>
                               ...
                               if(isset($_POST['add'])){
                                $addquery= "INSERT INTO course (Ccode,Cname, Cabb) VALUES ('$_POST[Ccode]','$_POST[Cname]', '$_POST[Cabb]') " ;
                            ...
                            ?>
                                <form action="" method="POST">  
                                    ...
                                    <td><input type= 'text' name='Ccode' > </td>
                                        ...
                                        <td><input type= 'text' name='Cabb' > </td>    
